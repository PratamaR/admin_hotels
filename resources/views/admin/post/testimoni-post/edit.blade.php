          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Testimoni Title" name="title" value="{{ $testimoni->title }}" >
              </div>
            </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Coment</label>
                    <textarea class="form-control textarea" placeholder="Coment" name="coment" >{{ $testimoni->coment }}</textarea>
                  </div>
                </div>
                </div>
          <div class="row">
