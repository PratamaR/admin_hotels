...
@section('content')
 ...
 <div class="row">
    ...
    <div class="card-body">
        <form method="post" action="/store-gallery" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control " placeholder="Title Name" name="title" required autocomplete autofocus >
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label>Category Gallery</label>
                    <select id="category" class="form-control" name="id_type" required autocomplete>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control textarea" placeholder=" Facility Description" name="description" required autocomplete></textarea>
                  </div>
                </div>
              </div>
              <div class="mb-3">
                <label for="formFileMultiple" class="form-label" >Input Picture File</label>
                <input class="form-control" type="file" name="picture" required multiple autocomplete>
              </div>
              <div class="form-group">
                <label>Status</label>
