...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail pr-lg-5 mb-100 wow fadeInUp" data-wow-delay="100ms">
                        <img src="{{ asset('frontend/assets/img/bg-img/19.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <!-- Section Heading -->
                    ...
                    <div class="about-content mb-100 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <img src="{{ asset('frontend/assets/img/core-img/signature.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Video Area Start -->
    <div class="roberto--video--area bg-img bg-overlay jarallax section-padding-0-100" style="background-image: url({{ asset('frontend/assets/img/bg-img/20.jpg') }});">
        <div class="container h-100">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area mb-100 wow fadeInUp" data-wow-delay="300ms">
                        <img src="{{ asset('frontend/assets/img/bg-img/21.jpg') }}" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <img src="{{ asset('frontend/assets/img/bg-img/22.jpg') }}" alt="">
                        <div class="service-title d-flex align-items-center justify-content-center">
                            <h5>Spa &amp; Fitness</h5>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area mb-100 wow fadeInUp" data-wow-delay="700ms">
                        <img src="{{ asset('frontend/assets/img/bg-img/23.jpg') }}" alt="">
                        <div class="service-title d-flex align-items-center justify-content-center">
                            <h5>Pool &amp; Party</h5>
                        </div>
                    </div>
                ...
                <div class="row align-items-baseline justify-content-between">
                    ...
                    <div class="col-12 col-sm-8 col-lg-4">
                        <div class="single-footer-widget mb-80">
                            ...
                            <!-- Newsletter Form -->
                            <form action="/frontend" class="nl-form">
