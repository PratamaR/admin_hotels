...
Route::get('/list-reservation',[ReservationController::class,'index'])->name('reservation-list')->middleware('auth');
Route::get('/add-reservation', [ReservationController::class, 'create'])->name('reservation-create')->middleware('auth');
Route::post('/store-reservation', [ReservationController::class, 'store'])->middleware('auth');
Route::get('/edit-reservation/{id}', [ReservationController::class, 'edit'])->name('reservation-edit')->middleware('auth');
